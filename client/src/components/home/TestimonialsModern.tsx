...
const testimonials = [
  {
    ...
    rating: 5,
    comment: 'Gentle Clearing & Forwarding has transformed our supply chain operations. Their attention to detail and commitment to on-time delivery is exceptional. We\'ve seen a 40% improvement in our logistics efficiency.',
  ...
  },
  {
    ...
    rating: 5,
    comment: 'Reliable, efficient, and cost-effective. Gentle Clearing & Forwarding is our go-to partner for all logistics needs. Their customer service team is always responsive and helpful.',
