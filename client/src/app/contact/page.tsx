...
export default function ContactPage() {
  const contactInfo = [
    ...
    },
    {
      icon: Phone,
      title: 'Phone Numbers',
      details: ['+231 777 55 0506', '+231 886 550 506', 'Toll-free: 0800-GENTLE'],
      color: 'text-primary'
    },
    {
      icon: Mail,
      title: 'Email Addresses',
      details: ['info@gentleclearing.com', 'quotes@gentleclearing.com', 'support@gentleclearing.com'],
      color: 'text-primary'
    },
    {
      icon: Clock,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Contact <span className="bg-gradient-to-r from-primary to-primary/80 bg-clip-text text-transparent">Gentle Clearing & Forwarding</span>
            </h1>
          ...
          >
            ...
            <div className="relative h-96">
              ...
              <div className="absolute top-4 left-4 bg-white px-4 py-2 rounded-lg shadow-lg flex items-center space-x-2">
                ...
                <span className="text-sm font-medium">Gentle Clearing & Forwarding HQ</span>
              </div>
            </div>
            ...
            <div className="p-8 border-t">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                ...
                <div className="flex items-center justify-center space-x-3">
                  ...
                  <span className="text-gray-700">info@gentleclearing.com</span>
                </div>
              </div>
            </div>
          </motion.div>
